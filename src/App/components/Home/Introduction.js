...
class Intruduction extends React.Component {
    render() {
        return (
            <div class="col-sm-12 offset-sm-0 col-md-6 offset-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="lead">Moin, ich bin Eike Wientjes, {this.calculateAge('01-15-2002')} Jahre alt und komme aus einer kleinen Stadt in Niedersachsen</p>
                        <p class="lead">
